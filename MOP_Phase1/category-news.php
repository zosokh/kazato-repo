...
<!-- Contents -->	
			...
			<div id="contents-right_page">
                ...
                <div class="top_topic_page" >
                    ...
                    <div style="margin: 0px 80px 50px 80px; padding-bottom:40px; border-bottom:1px solid #000;" class="post">
                        ...
                        <div class="nav-below">
		                    ...
		                    <span class="nav-next">
		                    	<?php previous_posts_link('<img src="/mop_phase01/wp-content/themes/MOP_Phase1/image/next_page.png" />') ;?>
		                    </span>
		                </div><!-- /.nav-below -->
